...
@CacheDirective(type = {Byte.class, Short.class, Integer.class, Long.class}, name = HttpCacheConstants.MIN_FRESH, resolver = IntegralHttpCacheDirectiveResolver.class)

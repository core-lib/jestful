...
@CacheDirective(type = {Byte.class, Short.class, Integer.class, Long.class}, name = HttpCacheConstants.MAX_STALE, resolver = IntegralHttpCacheDirectiveResolver.class)

...
public interface BeanContainer extends Enumerable<Bean> {
     ...
     * @throws BeanUndefinedException if not contains any bean named of specified parameter
     */
     ...
     * @return bean named of specified parameter
     * @throws BeanUndefinedException if not contains any bean named of specified parameter
     * @throws ClassCastException     if bean named name parameter but isn's instance of type parameter
     */
     ...
     * @throws BeanUndefinedException if no any bean is instance of specified type parameter
     * @throws BeanNonuniqueException if more than one bean is instance of specified type parameter
     */

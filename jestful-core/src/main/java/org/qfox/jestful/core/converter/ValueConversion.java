...
public class ValueConversion {
    ...
    public static Method getSerializeMethod(Class<?> klass) {
        ...
        while (klass != Object.class) {
            ...
            for (Method method : methods) {
                ...
                if (method.getReturnType() != Map.class) continue;
    ...
    public static Method getDeserializeMethod(Class<?> klass) {
        ...
        for (Method method : methods) {
            ...
            if (method.getParameterTypes().length != 1 || method.getParameterTypes()[0] != Map.class) continue;
            return method;
        }
        return null;
    }
    ...
    public static Constructor<?> getDeserializeConstructor(Class<?> klass) {
        ...
        for (Constructor<?> constructor : constructors) {
            ...
            if (constructor.getParameterTypes().length != 1 || constructor.getParameterTypes()[0] != Map.class) continue;
            return constructor;
        }
        return null;
    }

...
public class Jdk1_7AioOptions implements AioOptions {
    ...
    public Jdk1_7AioOptions setSo_broadcast(boolean so_broadcast) {
    ...
    public Jdk1_7AioOptions setSo_keepalive(boolean so_keepalive) {
    ...
    public Jdk1_7AioOptions setSo_sndbuf(int so_sndbuf) {
    ...
    public Jdk1_7AioOptions setSo_rcvbuf(int so_rcvbuf) {
    ...
    public Jdk1_7AioOptions setSo_reuseaddr(boolean so_reuseaddr) {
    ...
    public Jdk1_7AioOptions setSo_linger(int so_linger) {
    ...
    public Jdk1_7AioOptions setIp_tos(int ip_tos) {
        this.ip_tos = ip_tos;
        return this;
    }
    ...
    public Jdk1_7AioOptions setIp_multicast_if(NetworkInterface ip_multicast_if) {
    ...
    public Jdk1_7AioOptions setIp_multicast_ttl(int ip_multicast_ttl) {
    ...
    public Jdk1_7AioOptions setIp_multicast_loop(boolean ip_multicast_loop) {
    ...
    public Jdk1_7AioOptions setTcp_nodelay(boolean tcp_nodelay) {
